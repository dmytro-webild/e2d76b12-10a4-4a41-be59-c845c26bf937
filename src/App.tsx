...
import { Award, Globe, HelpCircle, MessageCircle, Phone, Shield, Sparkles, Star, Users, Zap, Lock } from "lucide-react";
...
export default function LandingPage() {
  ...
  <div id="contact" data-section="contact">
      ...
      description="Please fill out the form below. By submitting, you consent to receive SMS updates from our team."
      inputs={[
      ...
      ctaLinks={[
          ...
          { icon: Lock, label: "Terms of Service" }
      ]}
    />
  </div>
